        ...
        <div class="max-w-3xl mx-auto text-center">
            <div class="bg-darkCard rounded-xl p-12 relative overflow-hidden">
                ...
                <p class="text-xl text-grayText mb-8">
                    Merci pour votre demande de devis. Je l'ai bien reçue et je vous contacterai dans les plus brefs délais.
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    <div class="bg-darkCard p-6 rounded-xl">
                        ...
                        <p class="text-grayText text-center">
                            J'analyse votre demande et prépare une proposition adaptée à vos besoins.
                        </p>
                    </div>
                    ...
                    <div class="bg-darkCard p-6 rounded-xl">
                        ...
                        <p class="text-grayText text-center">
                            Je vous contacte sous 48h pour discuter des détails de votre projet.
                        </p>
                    </div>
